...
namespace BankTransactionWeb.DAL.InMemoryDAL
{
    public class InMemoryContainer
    {
        ...
        //    var transaction1 = new Transaction { Id = 1, Amount = 300, DateOftransfering = new DateTime(2004, 8, 3), Number = "00000000" };
        //    var transaction2 = new Transaction { Id =2,  Amount = 70, DateOftransfering = new DateTime(2006, 6, 3), Number = "00000001" };
        //    var transaction3 = new Transaction { Id = 3,  Amount = 70, DateOftransfering = new DateTime(2009, 8, 3), Number = "00000002" };
        //    var transaction4 = new Transaction { Id = 4, Amount = 34, DateOftransfering = new DateTime(2004, 8, 3), Number = "00000003" };
        //    var transaction5 = new Transaction { Id = 5,  Amount = 900, DateOftransfering = new DateTime(2004, 8, 3), Number = "00000004" };
        //    var transaction6 = new Transaction { Id =6,  Amount = 800, DateOftransfering = new DateTime(2004, 8, 3), Number = "00000005" };
        //    account1.TransactionsForSource = new List<Transaction> { transaction1, transaction2 };
        //    account2.TransactionsForSource = new List<Transaction> { transaction3, transaction4 };
        //    account3.TransactionsForSource = new List<Transaction> { transaction5 };
        //    account4.TransactionsForSource = new List<Transaction> { transaction6 };
